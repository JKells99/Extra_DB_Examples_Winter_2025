package org.keyin.spacesystem.dbauth;
...
public class DatabaseAuth {
    static Logger logger = Logger.getLogger(DatabaseAuth.class.getName());
    // You only need to change the name of the database in the URL, unless PG runs on another port on your system
    private static final String URL = "jdbc:postgresql://localhost:5433/rbacexample";
